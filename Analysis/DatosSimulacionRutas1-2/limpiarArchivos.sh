...
cat $1/output18 | grep 'HCI\|RSSI\|bdaddr' >$1/p18 
cat $1/output19 | grep 'HCI\|RSSI\|bdaddr' >$1/p19 
cat $1/output20 | grep 'HCI\|RSSI\|bdaddr' >$1/p20 
cat $1/output21 | grep 'HCI\|RSSI\|bdaddr' >$1/p21 
